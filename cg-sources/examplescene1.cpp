...
void ExampleScene1::render()
{
	...
	R = glm::mat4(1.0f);
	R = glm::translate(R, glm::vec3(1.0, 0.0, 0.0)); // Translate object +1 on x-axis after rotation
	R = glm::rotate(R, rotation, glm::vec3(0.0, 1.0, 0.0)); // Rotate object around y-axis
	R = glm::scale(R, glm::vec3(0.5f, 0.5f, 0.5f));
